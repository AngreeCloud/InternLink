...
export function EditEstagioSheet({ estagio, open, onOpenChange, onSaved }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 z-50 flex h-full w-full max-w-2xl flex-col border-l bg-background shadow-xl overflow-y-auto">
