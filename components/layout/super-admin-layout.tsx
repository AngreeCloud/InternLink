...
const navItems = [
  { name: "Visão Geral", href: "/super-admin", icon: Home },
  { name: "Escolas & Leads", href: "/super-admin/escolas", icon: School },
  { name: "Contas Support", href: "/super-admin/support", icon: Headset },
  { name: "Landing Page", href: "/super-admin/landing", icon: Edit3 },
];
    ...
    (async () => {
      ...
      const unsubscribe = onAuthStateChanged(auth, async (firebaseUser) => {
        ...
        try {
          ...
          const userData = userSnap.data() as { role?: string; estado?: string; nome?: string };
          ...
          setUser({
            ...
            displayName: userData.nome || firebaseUser.displayName || "Super Admin",
          });
